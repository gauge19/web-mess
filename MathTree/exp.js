...
let e = [
    ...
    new Subtraction(new Addition(new Multiplication(new Constant(3), new Variable("x")), new Variable("y")), new Multiplication(new Constant(2), new Variable("y"))),
    new Subtraction(new Multiplication(new Constant(3), new Addition(new Variable("x"), new Variable("y"))), new Multiplication(new Constant(2), new Variable("y"))),
